...
#                                )
    ...
    def _get_survivable_actions(self, survivable, obs, curr_bombs, curr_flames,
                                enemy_mobility=0, enemy_bomb=0, agent_blast_strength=dict()):
    ...
    def _get_frac_blocked_two_lists(self, list_boards_with_action, n_survivable_nodes, board, agents):
        ...
        for agent in agents:
            ...
            _survivable = search_time_expanded_network(list_boards_with_action,
                                                       position)
            n_survivable_nodes_with_action[agent] = sum([len(positions) for positions in _survivable])
