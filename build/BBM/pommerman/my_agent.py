...
class MyAgent(SimpleAgentDebugged):
    ...
    def act(self, obs, action_space):
        ...
        for enemie in enemies:
            enemies_list.append(enemie.value)
        enemies_list_buffer = pack_into_buffer2(enemies_list)



        # call Java function.
        action = self._addition_app.act(x, y, ammo, blast_strength, can_kick, board_buffer, bomb_blast_strength_buffer, bomb_life_buffer, alive_buffer, enemies_list_buffer)
        #action = self._addition_app.act(x, y, ammo, blast_strength, board_buffer, bomb_blast_strength_buffer, bomb_life_buffer, alive_buffer, enemies_list_buffer)
        #action = self._addition_app.act(x, y, board_buffer, bomb_blast_strength_buffer, bomb_life_buffer, alive_buffer, enemies_list_buffer)
