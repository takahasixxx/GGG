...
public class GlobalParameter {
	...
	// static public double gainOffset;
	...
	// for (double rateLevel : new double[] { 1.2, 1.4, 1.6, 1.8, 2 }) {
	// for (double gainOffset : new double[] { 1.2, 1.4, 1.6, 1.8, 2.0 }) {
	// double[] param = new double[] { rateLevel, usualCell, attackCell, gainOffset };
	// params.add(param);
	// }
	// }
	// }
	...
	// String line = String.format("GlobalParameter: Statistics, params=(%f, %f, %f, %f), (total/win/lose/tie)=(%f/%f/%f/%f)", param[0], param[1],
	// param[2], param[3], numTotal, numWin, numLose,
	// numTie);
	...
	// // GlobalParameter.gainOffset = param[3];
	//
	// // 戦績リセット
	// numWin = 0;
	// numLose = 0;
